<?php
/**
 * File for ConvertAreaWsdlClass to communicate with SOAP service
 * @package ConvertArea
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
/**
 * ConvertAreaWsdlClass to communicate with SOAP service
 * 
 * @package ConvertArea
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class ConvertAreaWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses ConvertAreaWsdlClass::setLastError()
	 * @uses ConvertAreaWsdlClass::initSoapClient()
	 * @uses ConvertAreaWsdlClass::initInternArrayToIterate()
	 * @uses ConvertAreaWsdlClass::_set()
	 ...
	 * @return ConvertAreaWsdlClass|null
	 */
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'ConvertAreaWsdlClass'))
			{
	 ...
	 * @uses ConvertAreaClassMap::classMap()
	 * @uses ConvertAreaWsdlClass::getDefaultWsdlOptions()
	 * @uses ConvertAreaWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('ConvertAreaClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = ConvertAreaClassMap::classMap();
	 ...
	 * @uses ConvertAreaWsdlClass::WSDL_CACHE_WSDL
	 * @uses ConvertAreaWsdlClass::WSDL_COMPRESSION
	 * @uses ConvertAreaWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses ConvertAreaWsdlClass::WSDL_ENCODING
	 * @uses ConvertAreaWsdlClass::WSDL_EXCPTS
	 * @uses ConvertAreaWsdlClass::WSDL_FEATURES
	 * @uses ConvertAreaWsdlClass::WSDL_LOGIN
	 * @uses ConvertAreaWsdlClass::WSDL_PASSWD
	 * @uses ConvertAreaWsdlClass::WSDL_SOAP_VERSION
	 * @uses ConvertAreaWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses ConvertAreaWsdlClass::WSDL_TRACE
	 * @uses ConvertAreaWsdlClass::WSDL_TYPEMAP
	 * @uses ConvertAreaWsdlClass::WSDL_URL
	 * @uses ConvertAreaWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::getSoapClient()
	 * @uses ConvertAreaWsdlClass::getFormatedXml()
	 ...
	 * @uses ConvertAreaWsdlClass::getSoapClient()
	 * @uses ConvertAreaWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses ConvertAreaWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::getInternArrayToIterate()
	 * @uses ConvertAreaWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::getInternArrayToIterateOffset()
	 * @uses ConvertAreaWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::getInternArrayToIterateOffset()
	 * @uses ConvertAreaWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @see ConvertAreaWsdlClass::offsetGet()
	 * @uses ConvertAreaWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::getAttributeName()
	 * @uses ConvertAreaWsdlClass::__toString()
	 * @uses ConvertAreaWsdlClass::_set()
	 * @uses ConvertAreaWsdlClass::_get()
	 * @uses ConvertAreaWsdlClass::setInternArrayToIterate()
	 * @uses ConvertAreaWsdlClass::setInternArrayToIterateIsArray()
	 * @uses ConvertAreaWsdlClass::setInternArrayToIterateOffset()
	 ...
	 * @uses ConvertAreaWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses ConvertAreaWsdlClass::item()
	 * @uses ConvertAreaWsdlClass::length()
	 * @return mixed
	 */
